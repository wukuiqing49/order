...
public class NovelSubscriptionActivity extends MvpBindingActivity<NovelSubscriptionView, NovelSubscriptionPresenter, ActivityNovelSubscribeBinding> {

    public static void startActivity(Context context) {
        Intent intent = new Intent(context, NovelSubscriptionActivity.class);
