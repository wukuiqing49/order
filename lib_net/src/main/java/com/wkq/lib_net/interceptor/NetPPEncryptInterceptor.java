...
import com.wkq.lib_net.util.SignUtil;
...
public class NetPPEncryptInterceptor implements Interceptor {
    @Override
...
//            }
//
//            for (Map.Entry<String, String> entity : SignUtil.getNetPPSignString(parameter).entrySet()) {
