package com.wkq.lib_net.interceptor;
...
public class SignEncrypt2Interceptor implements Interceptor {

    private boolean valueUrlencode = false;

    public SignEncrypt2Interceptor() {

    }

    public SignEncrypt2Interceptor(boolean valueUrlencode) {
...
//                builder.add(entity.getKey(), URLEncoder.encode(entity.getValue(), "UTF-8"));
//            }
...
//                for (Map.Entry<String, String> entity : SignUtil.getOpenSignMap(parameter, valueUrlencode).entrySet()) {
//                    authorizedUrlBuilder.addQueryParameter(entity.getKey(), URLEncoder.encode(entity.getValue(), "UTF-8"));
//                }
